...
import 'package:faultconnectdashboard/Authentication/register_page.dart';
import 'package:faultconnectdashboard/HomePage/map_screen.dart';
    ...
    try {
      ...
      if (context.mounted) {
        ...
        Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(builder: (context) => const MapScreen()), // Replace 'HomeScreen()' with your actual home screen widget
              (route) => false,
        );
      }
